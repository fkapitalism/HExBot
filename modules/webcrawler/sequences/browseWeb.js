...
foo.instructions = [
	...
	{"@analyseTargetIps": 			["getUserCommandsResult", {"jumpif": ["*.cleaningLogsDisabled", "@fileCreating"]}, "cancelLogProcesses", "goToTargetLogs", "isThereLogs", {"jumpif": ["!*.$","@fileCreating"]}, "cleanMyIpClues", "getIpsFromLogs", "getBTCAccounts", "getShoppingLogs", "leaveSignature", "updateCrawlerLogs", "submitLogs", "isThereMessageError", {"jumpif":["*.$", "@fileCreating"]}, "waitProgressBar"]},
	{"@fileCreating": 				["createFiles",{"jumpif": ["*.$ <= 1", "@getSoftwares"]}]},
	{"@cleanMyFileCreatingClues": 	[{"jumpif": ["*.cleaningLogsDisabled", "@getSoftwares"]}, "goToTargetLogs", "registerInstalled", "isThereLogs", {"jumpif": ["!*.$", "@getSoftwares"]}, "cleanMyIpClues", "submitLogs", "isThereMessageError", {"jumpif":["*.$", "@getSoftwares"]}, "waitProgressBar"]},
